const Inbox = () => {
  return (
    <div>
      <p
        tabIndex={0}
        className="py-5 focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800"
      >
        Messagerie
      </p>
      <main className="flex w-full h-[55rem] shadow-lg rounded-3xl">
        <section className="flex flex-col pt-3 w-2/5 bg-gray-50 h-full overflow-y-scroll">
        ...
        <section className="w-3/5 px-4 flex flex-col bg-white rounded-r-3xl">
          ...
          <section>
            ...
            <article className="mt-8 text-gray-500 leading-7 tracking-wider">
              ...
              <p>
                ...
                backends.Work with Product Managers and User Experience designers to create an
                appealing user experience for desktop web and mobile web.
              </p>
