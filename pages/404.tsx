        ...
        <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full md:w-1/2">
            ...
            <div className="mb-10 md:mb-20 text-gray-600 font-light">
              ...
              <p>Essayez à nouveau de rechercher ou utilisez le bouton Retour ci-dessous.</p>
            </div>
            <div className="mb-20 md:mb-0">
              <Link href="/" className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600">
                🔙 Retour
              </Link>
            </div>
          </div>
