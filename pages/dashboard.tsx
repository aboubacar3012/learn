...
const Dashboard = (props) => {
  ...
  const handleSubmitSearch = (event) => {
    ...
    const toShow = users.filter(user => search.length > 3 ? user.id.includes(search) || user.email.includes(search) || user.phone.includes(search) : user);
          ...
          <div className="relative bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
            <div className="sticky top-0 sm:flex items-center justify-between">
              <div className="flex items-center">
                ...
                >
                  <div  className={`py-2 px-8 ${filterIndex === 1 && 'bg-indigo-100'} text-indigo-700 rounded-full`}>
                    <p>Tous</p>
                  </div>
                </div>
                <div
                ...
                >
                  <div  className={`py-2 px-8 ${filterIndex === 2 && 'bg-indigo-100'} text-indigo-700 rounded-full`}>
                    <p>Débutants</p>
                  </div>
                </div>
                <div
                ...
                >
                  <div  className={`py-2 px-8 ${filterIndex === 3 && 'bg-indigo-100'} text-indigo-700 rounded-full`}>
                    <p>Pros</p>
                  </div>
                </div>
                <div
                ...
                >
                  <div  className={`py-2 px-8 ${filterIndex === 4 && 'bg-indigo-100'} text-indigo-700 rounded-full`}>
                    <p>Experts</p>
                  </div>
                </div>
                <div
                ...
                >
                  <div  className={`py-2 px-8 ${filterIndex === 5 && 'bg-indigo-100'} text-indigo-700 rounded-full`}>
                    <p>Actifs</p>
                  </div>
                </div>
                <div
                ...
                >
                  <div className={`py-2 px-8 ${filterIndex === 6 && 'bg-indigo-100'} text-indigo-700 rounded-full`}>
                    <p>Inactifs</p>
                  </div>
                </div>
              </div>
              
              <form className="hidden md:block w-4/12"	onSubmit={handleSubmitSearch}>   
                  <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
                  <div className="relative">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                          <svg aria-hidden="true" className="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                      </div>
                      <input value={search} onChange={(event) => setSearch(event.target.value)} type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Rechercher par Matricule, Email ou Telephone" required />
              ...
              <table className="w-full whitespace-nowrap">
                <thead>
                  <tr>
                    ...
                    <th className="py-3 text-blue-900 bg-blue-300">Date de naissance</th>
                    <th className="py-3 text-blue-900 bg-blue-300">E-mail</th>
                    <th className="py-3 text-blue-900 bg-blue-300">Telephone</th>
                    <th className="py-3 text-blue-900 bg-blue-300">Status</th>
                    <th className="py-3 text-blue-900 bg-blue-300"></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <td className="">
                    <p className="text-base text-center font-medium leading-none text-gray-700 mr-2">
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" value="" className="sr-only peer" checked={user.isActive} />
