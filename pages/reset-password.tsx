...
const ResetPassword = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const response = await fetch(url, {
      ...
      body: JSON.stringify({ email, password, dateOfBirth: formatDate(dateOfBirth) }),
    })
  ...
  return (
    <div className="max-w-screen mx-auto m-0 sm:m-20 bg-white shadow sm:rounded-lg justify-center items-center flex">
      <div className="lg:w-2/3 xl:w-2/3 p-6 sm:p-12">
        <div className="mt-12 flex flex-col items-center">
          <h1 className="text-2xl xl:text-3xl font-extrabold">Modification de mot de passe</h1>
